 ...
 * cinta por película y con cierto tipo de cinta magnetica). De las películas
 * interesa guardar el título, el autor, el año de edición y el idioma (o los
 * idiomas, en caso de DVD). El precio de alquiler de las películas varía en
 * función del tipo de película. Las DVD siempre son 10% mas caras que las de
 * VHS.
 *
 * Note
 *
 ...
 * jerarquico de clases, instancia en el clase de prueba Ejecutor (la-s clase-s
 * respectiva-s), con datos aleatorios. Los escenarios de prueba pueden darse
 * para el alquiler de una o varias peliculas según la preferencia del usuario.
 *
 * @author paulo
 */
